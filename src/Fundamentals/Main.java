...
public class Main {
    ...
    // your main method is considered the entry point
    // public is the access modifier
    // static means that this code belongs class implementation/ state
    ...
    public static void main(String[] args){
        ...
        System.out.println((southWall.getAmountOfWalls()));
    }
}
